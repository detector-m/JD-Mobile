...
@interface DZCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation DZCycleScrollView
...
- (void)initialization {
    _pageControlAliment = DZCycleScrollViewPageContolAlimentCenter;
    ...
    _pageControlStyle = DZCycleScrollViewPageContolStyleAnimated;
...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame imagesGroup:(NSArray *)imagesGroup {
    DZCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView {
    ...
    [mainView registerClass:[DZCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setPageControlDotSize:(CGSize)pageControlDotSize {
    ...
    if ([self.pageControl isKindOfClass:[DZPageControl class]]) {
        DZPageControl *pageContol = (DZPageControl *)_pageControl;
...
- (void)setPageControlStyle:(DZCycleScrollViewPageContolStyle)pageControlStyle {
...
- (void)setupPageControl {
    ...
    switch (self.pageControlStyle) {
        case DZCycleScrollViewPageContolStyleAnimated:
            {
                DZPageControl *pageControl = [[DZPageControl alloc] init];
        ...
        case DZCycleScrollViewPageContolStyleClassic:
            {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    DZCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
