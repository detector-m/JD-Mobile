...
#import "DZCashierViewController.h"

@interface DZOrderViewController ()<UITableViewDataSource, UITableViewDelegate>
{
    UIView * _buttomView;
    int _count;
    float _money;
...
-(void)submitClick{
    [self.navigationController pushViewController:[[DZCashierViewController alloc]initWithOrderMoney:_money*_count] animated:YES];
}
...
//                cell.detailTextLabel.font = [UIFont systemFontOfSize:15];
        ...
        case 1:
            ...
            cell.textLabel.textColor = DZColor(147, 147, 147);
            cell.textLabel.font = [UIFont systemFontOfSize:15];
            cell.detailTextLabel.textColor = DZColor(79, 79, 79);
            cell.detailTextLabel.font = [UIFont systemFontOfSize:15];
            break;
        case 2:
            if (indexPath.row == 0) {
...
- (UIView*)addFooterBar{
    ...
    moneyName.text = @"商品金额";
    moneyName.textColor = DZColor(147, 147, 147);
    ...
    money.textColor = DZColor(255, 100, 98);
    ...
    freightName.text = @"运费";
    freightName.textColor = DZColor(147, 147, 147);
    ...
    freight.textColor = DZColor(255, 100, 98);
